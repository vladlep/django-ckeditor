...
def get_upload_filename(upload_name, user):
    ...
    return utils.get_storage().get_available_name(os.path.join(upload_path, upload_name))
...
def upload(request):
    ...
    saved_path = utils.get_storage().save(upload_filename, upload)
...
def get_image_files(user=None, path=''):
    ...
    try:
        storage_list = utils.get_storage().listdir(browse_path)
